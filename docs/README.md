...
| [`parser-e-importacion.md`](parser-e-importacion.md) | El relevamiento de los servicios de Balance360, el parser de PDF con sus dos layouts y sus reglas por letra, y `POST /invoice-templates/import` |
...
| [`balance360.md`](balance360.md) | La integración con Balance360: el push tras emitir, el estado por factura, el token cifrado y el contrato entre las dos apps |
| [`ownership-y-tests.md`](ownership-y-tests.md) | `user_id` y el scoping de todas las queries, y las convenciones de la suite |
| [`monetizacion.md`](monetizacion.md) | Free y Pro, el trial, por qué el plan se deduce, los dos límites y su 402, y el cobro por Mercado Pago |
